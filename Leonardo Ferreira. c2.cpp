...
#include <locale.h> //biblioteca de alocações de texto pro região
...
int registro() //Função responsavel pro cadastrar os usuários no sistema 
{
	...
	char sobrenome[40];
	char cargo[40];
	//final da criação de veriáveis/string
	...
	fprintf(file,cpf); //salvar o valor da varialvel
...
int consulta() //Função responsavel pro consultar os usuários no sistema 
{
	setlocale (LC_ALL, "Portuguese"); //Definindo a linguagem
	//início da criação da variáveis/string 
	char cpf[40];
	char conteudo[200];
...
int main()
	...
	for(laco=1;laco=1;)
	{
        ...
        system("cls");//responsalvel por limar a tela
        
        
        switch(opcao)//início da seleção do menu
        {
        	case 1:
        	registro();//chamanda de funções 
    	    break;
    		...
    		case 4:
    		printf("Obrigado por utilizar p sistema\n");
    		return 0;
    		break;
